    ...
    <div>
      <nav className="admin__nav">
          <div className="admin__nav__links">
            <Link to="/Admin-DashBoard-Manage-Movies" className={location.pathname === "/Admin-DashBoard-Manage-Movies" ? "admin__nav__link active__link" : "admin__nav__link"}>Manage Movies</Link>
          ...
          <div className="admin__nav__buttons" >
            <button className="admin__nav__button">Add Movies</button>
